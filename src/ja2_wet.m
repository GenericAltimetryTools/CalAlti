...
readjason2_check_wet(pass_num,min_cir,max_cir,min_lat,max_lat,dir_0);
% Step 3: show the wet delay(radiometer and model)
plot_jason2_check_wet(pass_num,min_cir,max_cir);
% Step 4: interpolation of  the wet delay to the fixed point.
wet_inter(min_cir,max_cir,pass_num,loc);
